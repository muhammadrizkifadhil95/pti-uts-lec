var images = [
    { time: "morning", url: "assets/img/bg/pagi.png" },
    { time: "afternoon", url: "assets/img/bg/sore.png" },
    { time: "evening", url: "assets/img/bg/malam.png" },
];
...
function setBackground() {
    var hour = parseInt(hoursLabel.innerHTML);
    var timeOfDay;
    ...
    var matchingImage = images.find(function (image) {
        return image.time === timeOfDay;
    });

    document.body.style.backgroundImage = "url('" + matchingImage.url + "')";
}
